# Flow3-Fecha-y-hora
En este flow mostramos la fecha y hora actual mediante un dashboard
## Introducción
...
![](https://github.com/EberGiovanni/Flow3-Fecha-y-hora/blob/main/Imagenes/Captura%20desde%202023-05-24%2021-12-14.png?raw=true)
